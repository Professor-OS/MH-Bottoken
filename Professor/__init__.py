...
PROFESSOR_TOKEN = config("PROFESSOR_TOKEN", default=None)
PROFESSOR_TOKEN2 = config("PROFESSOR_TOKEN2", default=None)
PROFESSOR_TOKEN3 = config("PROFESSOR_TOKEN3", default=None)
PROFESSOR_TOKEN4 = config("PROFESSOR_TOKEN4", default=None)
PROFESSOR_TOKEN5 = config("PROFESSOR_TOKEN5", default=None)
PROFESSOR_TOKEN6 = config("PROFESSOR_TOKEN6", default=None)
PROFESSOR_TOKEN7 = config("PROFESSOR_TOKEN7", default=None)
PROFESSOR_TOKEN8 = config("PROFESSOR_TOKEN8", default=None)
PROFESSOR_TOKEN9 = config("PROFESSOR_TOKEN9", default=None)
PROFESSOR_TOKEN10 = config("PROFESSOR_TOKEN10", default=None)
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))

PROFESSOR = TelegramClient('AgoraSwamy', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN) 
PROFESSOR2 = TelegramClient('AgoraSwamy2', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN2) 
PROFESSOR3 = TelegramClient('AgoraSwamy3', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN3) 
PROFESSOR4 = TelegramClient('AgoraSwamy4', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN4) 
PROFESSOR5 = TelegramClient('AgoraSwamy5', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN5) 
PROFESSOR6 = TelegramClient('AgoraSwamy6', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN6) 
PROFESSOR7 = TelegramClient('AgoraSwamy7', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN7) 
PROFESSOR8 = TelegramClient('AgoraSwamy8', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN8) 
PROFESSOR9 = TelegramClient('AgoraSwamy9', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN9) 
PROFESSOR10 = TelegramClient('AgoraSwamy10', APP_ID, API_HASH).start(PROFESSOR_token=PROFESSOR_TOKEN10)


RAID = [
    "MADARCHOD TERI MAA KI CHUT ME PROFESSOR GHUTKA KHAAKE THOOK DUNGA 🤣🤣",
    "TERE BEHEN K CHUT ME TOXIC CHAKU DAAL KAR CHUT KA KHOON KAR DUGA",
    "TERI NEHAN NHI HAI KYA? 9 MAHINE RUK SAGI BEAHEEN DETA HU 🤣🤣🤩",
    ...
    "PROFESSOR AND TOXIC HAI OP TU HAI INLOGO KE LUND KE TOPI😙",
    "TERI MAA KI CHUT ME ✋ HATTH DALKE 👶 BACCHE NIKAL DUNGA 😍",
    "TERI BEHN KI CHUT ME KELE KE CHILKE 🍌🍌😍",
    "TERI BHEN KI CHUT ME USERPROFESSOR LAGAAUNGA SASTE SPAM KE CHODE",
    ...
    "TERI ITEM KI GAAND ME LUND DAALKE,TERE JAISA EK(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)NIKAAL DUNGA MADARCHOD🤘🏻🙌🏻☠️ ",
    ...
    "TERI MAA KI BADI BHUND ME ZOMATO DAL KE SUBWAY KA BFF VEG SUB COMBO [15cm , 16 inches ] ORDER COD KRVAUNGA(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)TERI MAA JAB DILIVERY DENE AYEGI TAB USPE JAADU KRUNGA(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)FIR 9 MONTH BAAD VO EK(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)FREE DILIVERY DEGI🙀👍🥳🔥",
    ...
    "TERI MAA KE BHOSDE MEI GITHUB DAL KE APNA PROFESSOR HOST KARUNGAA 🤩👊👤😍",
    ...
    "TOHAR MUMMY KI CHUT MEI PURI KI PURI KINGFISHER KI PROFESSORTLE DAL KE TOD DUNGA ANDER HI 😱😂🤩",
    ...
    "TERI ITEM KI GAAND ME LUND DAALKE,TERE JAISA EK(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)NIKAAL DUNGA MADARCHOD😆🤤💋",
    "TERI VAHEEN KO APNE LUND PR ITNA JHULAAUNGA KI JHULTE JHULTE HI BACHA PAIDA KR DEGI 💦💋",
    ...
    "HAHAHAH MERE BETE AGLI BAAR APNI MAAKO LEKE AAYA MATH KAT(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)MERE MOTE LUND SE CHUDWAYA MATH KAR",
    ...
    "GALI GALI ME REHTA HE SAND TERI MAAKO CHOD DALA(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)BANA DIA RAND 🤤🤣",
    "SAB BOLTE MUJHKO PAPA KYOUNKI MENE BANADIA TERI MAAKO PREGNENT 🤣🤣",
    "SUAR KE PILLE TERI MAAKI CHUTH ME SUAR KA LOUDA(PROFESSOR AND TOXIC HAI OP AND TU UNLOGO KE LUND KE TOPI 🤣🤣🤣)TERI BEHEN KI CHUTH ME MERA LODA",
